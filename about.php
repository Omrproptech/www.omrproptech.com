            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-lg-0 mt-5">
                    <div class="w3l-abouthny-info">
                        ...
                        <h3 class="title-w3l">The experts in local and international property</h3>
                        ...
                        <a href="#services" class="btn btn-style btn-primary mt-4">Discover our services <i class="fas fa-angle-double-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6 w3hny-passion-item">
                        <div class="row">
                            <div class="col-6 passion-grid-item-pic">
                                <img src="assets/images/d5.jpg" alt="" class="img-fluid radius-image">
                            </div>
                            <div class="col-6 passion-grid-item-pic">
                                <img src="assets/images/d4.jpg" alt="" class="img-fluid radius-image">
                            </div>
